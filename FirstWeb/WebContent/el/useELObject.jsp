...
<h1>${10+1}, ${10 div 3}, ${10 mod 3}</h1>
<h1>${10==1},${10 eq 1},${10 ne 1} , ${10 gt 1 }</h1>
...
<h1>${age > 19 ? '압장가능':'입장불가' }</h1>

<h1>요청 UIR <%=request.getRequestURL() %></h1>
<h1>요청 UIR ${pageContext.request.requestURI}</h1>

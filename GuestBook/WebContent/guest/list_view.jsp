...
<c:if test="${not empty listView.messageList}"> <!--  공백이 아니라면 -->
...
<c:if test="${listView.pageTotalCount >0 }"> <!-- 메세지토탈카운트가 0보다 크면 반복 -->

<div class="paging">
<c:forEach begin="1" end="${ listView.pageTotalCount }" var="num"> <!-- 비긴=1부터시작 -->
<a href="list.jsp?page=${num}" ${listView.currentPageNumber eq num? 'class="currentPage"1':''} }>[${num}]</a>
</c:forEach>
</div>
